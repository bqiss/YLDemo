...
- (void)setItemArray:(NSArray *)itemArray
{
    ...
    for (NSDictionary *dict in itemArray) {
        ...
        [button setImage:[UIImage imageNamed:dict[@"icon_open@2x"]] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:dict[@"icon_open@2x"]] forState:UIControlStateSelected];
        button.tag = 999 + n;
