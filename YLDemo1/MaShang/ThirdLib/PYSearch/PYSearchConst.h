...
#define PYSEARCH_SEARCH_HISTORY_CACHE_PATH2 [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"PYSearchhistories2.plist"] // the path of search record cached
